...
macro(spark_add_library_path _lib_name _lib_path)
    ...
    # file(GLOB HEADER_LIST RELATIVE ${CMAKE_CURRENT_SOURCE_DIR} ${_lib_path}/*.h)
    target_include_directories(${_lib_name} PUBLIC "${_lib_path}")
    ...
    # list(APPEND _lib_include_directories "${CMAKE_CURRENT_LIST_DIR}/${_lib_path}")
    # message("----> ${CMAKE_CURRENT_LIST_DIR}/${_lib_path}")
